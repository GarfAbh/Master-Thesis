...
void run_example_with_osrm() {
  ...
  vroom::TimeWindow vehicle_tw(0, 86340); // Working hours.
  vroom::Amount job_amount(1);
  vroom::Duration service = 15 * 60; // 5 minutes
  ...
  vroom::Vehicle corner_case(2,                // id
    depot,            // start
    house,            // end
    vehicle_capacity, // capacity
    {2},          // skills
    vehicle_tw);      // time window
    problem_instance.add_vehicle(corner_case);
    ...
    jobs.push_back(vroom::Job(1,
      vroom::Coordinates({{7.90922, 46.30108}}),
      service,
      job_amount,
      {1}));
    jobs.push_back(vroom::Job(2,
      vroom::Coordinates({{6.05140, 46.22235}}),
      service,
      job_amount,
      {1}));
    jobs.push_back(vroom::Job(3,
      vroom::Coordinates({{6.69823, 47.01608}}),
      service,
      job_amount,
      {1}));
    jobs.push_back(vroom::Job(4,
      vroom::Coordinates({{7.53945, 47.00022}}),
      service,
      job_amount,
      {1}));
    jobs.push_back(vroom::Job(5,
      vroom::Coordinates({{6.93713, 46.82031}}),
      service,
      job_amount,
      {1}));
    ...
    jobs.push_back(vroom::Job(6,
      vroom::Coordinates({{8.5372, 47.61138}}),
      service,
      job_amount,
      {2}));
    jobs.push_back(vroom::Job(7,
      vroom::Coordinates({{8.52187, 47.64753}}),
      service,
      job_amount,
      {2}));
    jobs.push_back(vroom::Job(8,
      vroom::Coordinates({{8.61806, 47.69785}}),
      service,
      job_amount,
      {2}));
